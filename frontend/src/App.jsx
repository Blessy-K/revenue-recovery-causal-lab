...
<section className="chart-section">
  <div className="section-header">
    <div>
      <h2>Treatment vs Control Recovery</h2>
      <p>
        Observed recovery rate with and without the retry intervention.
      </p>
    </div>
  </div>
<section className="chart-section">
  <div className="section-header">
    <div>
      <h2>Uplift Segment Analysis</h2>
      <p>
        Distribution of payments by predicted causal uplift.
      </p>
    </div>
  </div>
  ...
  <div className="segment-insight">
    <strong>369 payments</strong>
    <span>
      have predicted uplift above 10% and are recommended for retry.
    </span>
  </div>
</section>
<section className="model-section">
  <div className="section-header">
    <div>
      ...
      <p>
        Performance of the payment recovery prediction model on the test set.
      </p>
    </div>
  </div>
  ...
  <div className="causal-effect">
    <strong>+5.68%</strong>
    <span>Observed treatment effect</span>
  </div>
</section>
